###########################################################################
## Makefile generated for component 'class_d'. 
## 
## Makefile     : class_d.mk
## Generated on : Thu Oct 31 07:39:01 2024
## Final product: ./class_d.exe
...
PRODUCT_NAME              = class_d
MAKEFILE                  = class_d.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Aaron/Documents/GitHub/class-d-amp/loop_analysis/Matlab
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = class_d_comp.rsp
CMD_FILE                  = class_d.rsp
...
DEFINES_STANDARD = -DMODEL=class_d -DNUMST=2 -DNCSTATES=10 -DHAVESTDIO
...
OBJS = class_d.obj class_d_capi.obj class_d_data.obj class_d_tgtconn.obj rtGetInf.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/class_d/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/class_d/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/class_d/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/class_d/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/class_d/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
class_d.obj : $(START_DIR)/slprj/raccel/class_d/class_d.c
	$(CC) $(CFLAGS) -o "$@" "$<"


class_d_capi.obj : $(START_DIR)/slprj/raccel/class_d/class_d_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


class_d_data.obj : $(START_DIR)/slprj/raccel/class_d/class_d_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


class_d_tgtconn.obj : $(START_DIR)/slprj/raccel/class_d/class_d_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/slprj/raccel/class_d/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/class_d/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
