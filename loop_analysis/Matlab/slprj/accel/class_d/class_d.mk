...
## 
## Makefile     : class_d.mk
## Generated on : Thu Oct 31 03:10:41 2024
## Final product: ./class_d_acc.lib
...
SYSTEM_LIBS = -L"$(MATLAB_ROOT)/extern/lib/win64/mingw64"
...
%.obj : $(START_DIR)/slprj/accel/class_d/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/class_d/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/class_d/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/class_d/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/accel/class_d/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
