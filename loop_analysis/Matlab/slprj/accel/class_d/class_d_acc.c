...
TransportDelay_IWORK . Head ] = _rtB -> B_0_6_48 ; } UNUSED_PARAMETER ( tid )
; }
#define MDL_UPDATE
...
0 ] = 0.0 ; _rtXdot -> Integrator_CSTATE [ 0 ] = 0.0 ; _rtXdot ->
Integrator_CSTATE [ 0 ] += _rtP -> P_11 [ 0 ] * _rtX -> Integrator_CSTATE [ 0
] ; _rtXdot -> ZeroPole_CSTATE [ 1 ] = 0.0 ; _rtXdot -> Integrator_CSTATE [ 1
] = 0.0 ; _rtXdot -> Integrator_CSTATE [ 0 ] += _rtP -> P_11 [ 1 ] * _rtX ->
Integrator_CSTATE [ 1 ] ; _rtXdot -> ZeroPole_CSTATE [ 0 ] += _rtP -> P_2 [ 0
] * _rtX -> ZeroPole_CSTATE [ 0 ] ; _rtXdot -> ZeroPole_CSTATE [ 0 ] += _rtP
-> P_2 [ 1 ] * _rtX -> ZeroPole_CSTATE [ 1 ] ; _rtXdot -> ZeroPole_CSTATE [ 1
] += _rtX -> ZeroPole_CSTATE [ 0 ] * _rtP -> P_2 [ 2 ] ; _rtXdot ->
ZeroPole_CSTATE [ 0 ] += _rtP -> P_3 * _rtB -> B_0_0_0 ; _rtXdot ->
Integrator_CSTATE [ 1 ] += _rtX -> Integrator_CSTATE [ 0 ] ; _rtXdot ->
Integrator_CSTATE [ 0 ] += _rtB -> B_0_7_56 ; }
...
B_0_2_16 - _rtB -> B_0_8_64 ; } static void mdlInitializeSizes ( SimStruct *
S ) { ssSetChecksumVal ( S , 0 , 2576005559U ) ; ssSetChecksumVal ( S , 1 ,
3612564768U ) ; ssSetChecksumVal ( S , 2 , 325966079U ) ; ssSetChecksumVal ( S
, 3 , 1977971672U ) ; { mxArray * slVerStructMat = ( NULL ) ; mxArray *
