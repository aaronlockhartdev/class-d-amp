...
## 
## Makefile     : class_d.mk
## Generated on : Thu Oct 31 03:10:42 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/class_d_acc.mexw64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/class_d_acc.mexw64
...
DEFINES_STANDARD = -DMODEL=class_d -DNUMST=3 -DNCSTATES=7 -DHAVESTDIO -DMDL_REF_SIM_TGT=1
...
SRCS = $(START_DIR)/slprj/accel/class_d/class_d_acc.c $(START_DIR)/slprj/accel/class_d/class_d_acc_data.c $(MATLAB_ROOT)/extern/version/c_mexapi_version.c
...
OBJS = class_d_acc.obj class_d_acc_data.obj c_mexapi_version.obj
...
class_d_acc.obj : $(START_DIR)/slprj/accel/class_d/class_d_acc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


class_d_acc_data.obj : $(START_DIR)/slprj/accel/class_d/class_d_acc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
